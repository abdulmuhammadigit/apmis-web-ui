...
import { StorageService } from '../../../../../core/auth'

@Component({
	selector: 'kt-subheader-menu',
	templateUrl: './subheader-menu.component.html',
	styleUrls: ['./subheader-menu.component.scss'],
	changeDetection: ChangeDetectionStrategy.OnPush,
})
export class SubHeaderMenuComponent implements OnInit, AfterViewInit {
	// Public properties
	currentRouteUrl: any = '';
	...
	ngAfterViewInit(): void {
		this.SubHeaderService.menuList$.subscribe(next => {
			this.menuList = next;
	...
	isMenuItemIsActive(item): boolean {
		...
		if (item.page == this.currentRouteUrl) return true
		else return false;
