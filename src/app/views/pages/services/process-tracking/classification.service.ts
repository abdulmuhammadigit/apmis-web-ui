import { BASE_API_URL, BUSINESS_RULE_OPERATION, CLASSIFICATION_OPERATION } from './../../../../../environments/environment';
...
export class ClassificationService extends BaseService {
	...
	constructor(
		...
		@Inject(CLASSIFICATION_OPERATION) protected operationUrl: string,
		http: HttpClient
	) {
